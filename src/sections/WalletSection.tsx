...
export default function WalletSection({
  ...
  // Data fetching - use user transactions hook
  const { transactions: userTransactions, loading: transactionsLoading } =
    useUserTransactions();
  const walletData = useWalletData(partnerId);
  const { transactions, withdrawals } = useWalletFiltering(
    { ...walletData, data: userTransactions },
    searchQuery,
  );
